...
os.system('mkdir pvalues_greedyblock')
os.system('mkdir donorlists_greedyblock')
os.system('mkdir trial_histories_greedyblock')
os.system('mkdir summary_stats_greedyblock')
os.system('mkdir contingency_tables_greedyblock')


with open('contingency_tables_greedyblock/contingencies_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta) + '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid_cont:
...
with open('pvalues_greedyblock/pvalues_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta)  + '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid:
    for pval in pvals:
        fid.write(str(pval)+'\n')

with open('donorlists_greedyblock/donorlists_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta) + '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid:
    for donorlist in donorlists:
        fid.write(str(donorlist)+'\n')

with open('trial_histories_greedyblock/histories_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta) +  '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid:
...
with open('summary_stats_greedyblock/summary_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta) +  '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid:
