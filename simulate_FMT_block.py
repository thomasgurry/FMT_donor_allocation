...
os.system('mkdir pvalues_block_p')
os.system('mkdir donorlists_block_p')
os.system('mkdir trial_histories_block_p')
os.system('mkdir summary_stats_block_p')
os.system('mkdir contingency_tables_block_p')


with open('contingency_tables_block_p/contingencies_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta) + '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid_cont:
    fid_cont.write('successes_FMT\tsuccesses_placebo\tfailures_FMT\tfailures_placebo\n')
    for i in range(Ntrials):
        pval, end_state, donorlist, trial_history, contingency_table, top_donor_good = simulate_trial_block_allocation(npatients, ndonors, nblocks, phi, epsilon, beta, phi_a, phi_b, epsilon_a, epsilon_b, beta_a, beta_b)
        pvals[i] = pval
...
with open('pvalues_block_p/pvalues_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta)  + '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid:
    for pval in pvals:
        fid.write(str(pval)+'\n')

with open('donorlists_block_p/donorlists_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta) + '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid:
    for donorlist in donorlists:
        fid.write(str(donorlist)+'\n')

with open('trial_histories_block_p/histories_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta) +  '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid:
...
with open('summary_stats_block_p/summary_phi_' + str(phi) + '_eps_' + str(epsilon) + '_beta_' + str(beta) +  '_npatients_' + str(npatients) + '_ndonors_' + str(ndonors) + '_nblocks_' + str(nblocks) + '.txt', 'w') as fid:
